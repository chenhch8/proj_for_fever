...
from networks import AttentionLayer, ScoreLayer
...
def lstm_load_and_process_data(args: dict, filename: str, token_fn: 'function', fake_evi: bool=False, is_raw: bool=False) \
        -> DataSet:
    ...
    dataset = FeverDataset(cached_file, label2id=args.label2id, is_raw=is_raw)
    return dataset
