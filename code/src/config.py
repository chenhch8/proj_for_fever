...
def set_com_args(parser) -> None:
    ...
    parser.add_argument(
        "--per_gpu_train_batch_size", default=14, type=int, help="Batch size per GPU/CPU for training.",
    )
    parser.add_argument(
        "--per_gpu_eval_batch_size", default=14, type=int, help="Batch size per GPU/CPU for evaluation.",
    )
